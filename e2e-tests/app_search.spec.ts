...
test("app search - basic search dialog functionality", async ({ po }) => {
  ...
  await po.sendPrompt("create a todo application", { timeout: Timeout.LONG });
  ...
  // Create second app
  await po.sendPrompt("build a weather dashboard", { timeout: Timeout.LONG });
  ...
  // Create third app
  await po.sendPrompt("create a blog system", { timeout: Timeout.LONG });
...
test("app search - navigation and selection", async ({ po }) => {
  ...
  await po.sendPrompt("create first application", { timeout: Timeout.LONG });
  await po.navigation.goToAppsTab();

  await po.sendPrompt("create second application", { timeout: Timeout.LONG });
  await po.navigation.goToAppsTab();

  await po.sendPrompt("create third application", { timeout: Timeout.LONG });
  await po.navigation.goToAppsTab();
...
test("app search - empty search shows all apps", async ({ po }) => {
  ...
  // Create a few apps
  await po.sendPrompt("create alpha application", { timeout: Timeout.LONG });
  await po.navigation.goToAppsTab();

  await po.sendPrompt("create beta application", { timeout: Timeout.LONG });
  await po.navigation.goToAppsTab();

  await po.sendPrompt("create gamma application", { timeout: Timeout.LONG });
  await po.navigation.goToAppsTab();
