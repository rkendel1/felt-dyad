  ...
  return (
    <Popover>
      <Tooltip>
        ...
        <TooltipContent>Configure FeltDB AI settings</TooltipContent>
      </Tooltip>
        ...
        <div className="space-y-4">
          <div className="space-y-1">
            <h4 className="font-medium flex items-center gap-1.5">
              <Sparkles className="h-4 w-4 text-primary" />
              <span className="text-primary font-medium">FeltDB AI</span>
            </h4>
          ...
          <div className="flex flex-col gap-5">
            <SelectorRow
              id="pro-enabled"
              label="Enable FeltDB AI"
              tooltip="Uses FeltDB AI credits for the main AI model and AI modes."
            ...
            <SelectorRow
              id="web-search"
              label="Web Access"
              tooltip="Allows FeltDB Builder to access the web (e.g. search for information)"
