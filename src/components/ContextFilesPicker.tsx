            ...
            {contextPaths.length > 0 ? (
              ...
              <div className="rounded-md border border-dashed p-4 text-center">
                <p className="text-sm text-muted-foreground">
                  {isSmartContextEnabled
                    ? "FeltDB Builder will use Smart Context to automatically find the most relevant files to use as context."
                    : "FeltDB Builder will use the entire codebase as context."}
                </p>
              </div>
            )}
          </TooltipProvider>
